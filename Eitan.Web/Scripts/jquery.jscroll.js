...
(function($) {
    ...
    var jScroll = function($e, options) {
        ...
        function _load() {
            console.log('scroll event:' + isLoading);
            if ($(_options.nextSelector).is(':visible') && $('.jscroll-added .ajax-loading-image').length == 0) {
                console.log('if = true');
                isLoading = true;
                var $inner = $e.find('div.jscroll-inner').first();
                ...
                $inner.append('<div class="jscroll-added" />')
                    ...
                    .html('<div class="ajax-loading-image"></div>');

                setTimeout('$("' + _options.nextSelector + '").click();$(".ajax-loading-image").remove();', 1000);
            }
        }
